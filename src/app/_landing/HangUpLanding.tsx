...
import type { AuthenticatedUserInfo, UnauthenticatedUserInfo } from "@/types";
import { DEFAULT_MINUTES, MODES, phaseFromMinutes } from "./theme";
import Sky from "./Sky";

type LandingUserInfo =
...
export default function HangUpLanding({
  ...
  // Render the server-stable default first, then switch to the visitor's real
  // local time on mount (and once a minute) — avoids a hydration mismatch.
  ...
  const effectiveMinutes = minutes ?? DEFAULT_MINUTES;
